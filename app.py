...
# ==========================================
    ...
    def get_live_data():
        ...
        # Tablo başlıklarının çakışmasını engelleyen kurtarıcı filtre
        if isinstance(data.columns, pd.MultiIndex):
            data.columns = data.columns.droplevel(1)
        return data

    # Panel için fiyatları ve hedefleri güvenli varsayılan değerlerle başlatıyoruz
    ...
    try:
        ...
        # Eğer veri başarıyla geldiyse anlık fiyat üzerinden hesaplamaları güncelle
    ...
    if st.button("🚀 Otonom Analizi Başlat", use_container_width=True, type="primary"):
        ...
        # HATAYI YOK EDEN VE JİLET GİBİ PANELİ ÇIKARAN HTML BLOK
        panel_html = f"""
